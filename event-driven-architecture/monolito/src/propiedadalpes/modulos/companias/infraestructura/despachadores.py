...
from propiedadalpes.modulos.companias.infraestructura.schema.v1.eventos import CompaniaIngestadaPayload, EventoCompaniaIngestada
...
class Despachador:
    def _publicar_mensaje(self, mensaje, topico, schema):
        ...
        publicador = cliente.create_producer(topico, schema=AvroSchema(EventoCompaniaIngestada))
    ...
    def publicar_evento(self, evento, topico):
        ...
        evento_integracion = EventoCompaniaIngestada(data=payload)
        self._publicar_mensaje(evento_integracion, topico, AvroSchema(EventoCompaniaIngestada))
